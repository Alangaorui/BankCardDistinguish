...
import com.camera.CameraNativeHelper;
...
public class CardIDActivity extends AppCompatActivity {
    ...
    private boolean checkGalleryPermission() {
        int ret = ActivityCompat.checkSelfPermission(CardIDActivity.this, Manifest.permission
                .READ_EXTERNAL_STORAGE);
        if (ret != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(CardIDActivity.this,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.id_card_front_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CardIDActivity.this, CameraActivity.class);
